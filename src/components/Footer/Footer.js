  ...
  return (
    <footer>
      ...
      <div>
        <h3>POPULARS</h3>
        <ul>
          <li><Link to="/Explore/Seascapes%20nature">Seascapes</Link></li>
          <li><Link to="/Explore/Underwater">Underwater</Link></li>
          <li><Link to="/Explore/Cats">Cats</Link></li>
          <li><Link to="/Explore/Cute%20Animals">Cute Animals</Link></li>
          <li><Link to="/Explore/Birds%20Eye%20View">Birds Eye View</Link></li>
          <li><Link to="/Explore/Space">Space</Link></li>
          <li><Link to="/Explore/Macro">Macro</Link></li>
        </ul>
      </div>
      <div>
        <h3>BY LOCATION</h3>
